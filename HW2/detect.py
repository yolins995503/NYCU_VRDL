            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        # print("xyxy:",int(xyxy[1]))
                        # print("xyxy:",int(xyxy[2]))
                        # print("xyxy:",int(xyxy[3]))
                        # print("label:",label.split(' ')[0])
                        # print("score:",label.split(' ')[1])
                        # print("*********")
                        answer_label = int((label.split(' ')[0]))+1
                        if answer_label == 10:
                            answer_label = 0
